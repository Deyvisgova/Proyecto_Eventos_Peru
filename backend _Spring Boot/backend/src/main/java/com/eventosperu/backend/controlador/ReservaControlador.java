    ...
    public Reserva guardarReserva(@RequestBody Reserva reserva) {
        ...
        if (reserva.getDetalles() != null) {
            reserva.getDetalles().forEach(detalle -> {
                ...
                if (detalle.getServicio() != null && detalle.getServicio().getIdCatalogo() != null && detalle.getNombreServicio() == null) {
                    detalle.setNombreServicio(detalle.getServicio().getNombre());
                }
