        ...
        if (reserva.getDetalles() != null) {
            reserva.getDetalles().forEach(detalle -> {
                ...
                if (detalle.getServicio() != null && detalle.getServicio().getIdCatalogo() != null) {
                    catalogoServicioRepositorio.findById(detalle.getServicio().getIdCatalogo())
                            .ifPresent(catalogo -> {
                ...
                // Evita infringir claves foráneas cuando la base de datos apunta a la tabla `servicios`.
