        ...
        if (reserva.getDetalles() != null) {
            reserva.getDetalles().forEach(detalle -> {
                ...
                if (detalle.getServicio() != null && detalle.getServicio().getIdServicio() != null) {
                    Servicio servicio = servicioRepositorio.findById(detalle.getServicio().getIdServicio())
                    ...
                    if (detalle.getNombreServicio() == null) {
                        detalle.setNombreServicio(servicio.getNombreServicio());
                    }
                    if (detalle.getPrecioUnitario() == null && servicio.getPrecio() != null) {
