            ...
            reserva.getDetalles().forEach(detalle -> {
                ...
                if (detalle.getOpcion() != null && detalle.getOpcion().getIdOpcion() != null) {
                    ...
                    if (opcionCompleta != null) {
                        ...
                        if (opcionCompleta.getProveedorServicio() != null) {
                            catalogoServicio = opcionCompleta.getProveedorServicio().getCatalogoServicio();
                        }
                ...
                if (detalle.getServicio() != null && detalle.getServicio().getIdCatalogo() != null) {
                    CatalogoServicio catalogo = catalogoServicioRepositorio.findById(detalle.getServicio().getIdCatalogo())
                            .orElse(null);
                    if (catalogo != null) {
                        catalogoServicio = catalogo;
                        if (detalle.getNombreServicio() == null) {
                            detalle.setNombreServicio(catalogo.getNombre());
                        }
                    } else {
                ...
                if (catalogoServicio != null) {
                    detalle.setServicio(catalogoServicio);
                }
