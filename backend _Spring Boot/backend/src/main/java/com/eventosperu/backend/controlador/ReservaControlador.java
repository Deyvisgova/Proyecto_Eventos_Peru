...
public class ReservaControlador {
    ...
    public Reserva guardarReserva(@RequestBody Reserva reserva) {
        ...
        if (reserva.getDetalles() != null) {
            reserva.getDetalles().forEach(detalle -> {
                ...
                CatalogoServicio servicioCatalogo = null;
                if (detalle.getOpcion() != null && detalle.getOpcion().getIdOpcion() != null) {
                    ...
                    if (opcionCompleta != null) {
                        ...
                        if (opcionCompleta.getProveedorServicio() != null && opcionCompleta.getProveedorServicio().getCatalogoServicio() != null) {
                            servicioCatalogo = opcionCompleta.getProveedorServicio().getCatalogoServicio();
                        }
                        if (detalle.getNombreServicio() == null && servicioCatalogo != null) {
                            detalle.setNombreServicio(servicioCatalogo.getNombre());
                        } else if (detalle.getNombreServicio() == null && opcionCompleta.getProveedorServicio() != null) {
                ...
                if (servicioCatalogo == null && detalle.getServicio() != null && detalle.getServicio().getIdCatalogo() != null) {
                    servicioCatalogo = catalogoServicioRepositorio.findById(detalle.getServicio().getIdCatalogo())
                            .orElse(null);
                }

                if (servicioCatalogo != null) {
                    detalle.setServicio(servicioCatalogo);
                    if (detalle.getNombreServicio() == null) {
                        detalle.setNombreServicio(servicioCatalogo.getNombre());
                    }
                }
    ...
    public Reserva confirmar(@PathVariable Integer id) {
        ...
        String telefonoCliente = reserva.getCliente() != null && reserva.getCliente().getCelular() != null
                ? reserva.getCliente().getCelular()
                : "sin teléfono";

        String cuerpo = String.format(
                "Hola %s,\n\n" +
                        "Confirmamos tu reserva con %s.\n\n" +
                        "Detalle del evento:\n" +
                        "• Evento: %s\n" +
                        "• Fecha: %s\n" +
                        "• Contacto: %s (%s)\n\n" +
